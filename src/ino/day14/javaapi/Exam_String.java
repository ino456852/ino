...
//		data1 = data1.substring(4);
		System.out.print("문자열 자르기 " + data1);
		data1 = data1.substring(0,4);
		System.out.print("범위로 자르기 " + data1);
		
		// 문자열 -> 문자로 만들기
		char word = data1.charAt(0);
		System.out.print("문자로 자르기 : " + word);
	}
